...
import "./FundsDonation.css";
import VolunteerActivismIcon from "@mui/icons-material/VolunteerActivism";
import axios from "axios"
import { useParams } from "react-router-dom";

function FundsDonation() {
 const { id } = useParams();
...
const handlesubmit = async (e) => {
  e.preventDefault();
  try {
    let res = await axios.post(`${import.meta.env.VITE_API_URL}/fundraiser/fundsdonation/donate/${id}`, donation,{
...
const openRazorpay = (orderId, key, amount) => {
  const options = {
    ...
    handler: function (response) {
      ...
      axios.post(`${import.meta.env.VITE_API_URL}/fundraiser/verifypayment`, {
        razorpay_payment_id: response.razorpay_payment_id,
        razorpay_order_id: response.razorpay_order_id,
        razorpay_signature: response.razorpay_signature
      },{
